...
let data3 = myfunc2("alii", 100); // can sepcify before hand what exactly needs to be psssed in:
...
//call it:
let data4 = myfunc3("alii", 100); // as u can see, we only specified the T's type:
// --------------------------------------------------------------------------------------
// objects:
...
console.log(makeFullName2({
    ...
    lastName: "doe",
    age: 15
}) // as u can see, we were able to add the age here:
);
//----------------------------------------------------------------------------------------------------------------------------------------------
